  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: "在单细胞 KNN 图上用 Leiden 做社区发现。换分辨率做亚聚类，才能看见更细的状态。网页还点名 n_iterations=2：相对 Louvain 明显提升簇质量，又不必把计算预算烧光；即便只迭代两次，也能避开旧方法常见的「簇内部其实不连通」。",
      },
      {
        type: "p",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        kind: "cite",
        title: "原书网页 Key takeaways",
        body: "注释是给一群细胞贴上已知或未知的表型。手动注释靠 marker 和聚类，慢、主观，但对新组织仍然不可少。自动方法（CellTypist、基于 scArches 的参考映射 / cellmapper）更快、也不必先聚类，准不准取决于参考有多像你的数据。自动结果是初稿：用 marker 和不确定度做终审，不要直接写进论文。",
      },
      {
        type: "figure",
