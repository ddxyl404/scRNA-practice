...
const IMAGES: Record<string, { src: string; alt: string }> = {
  ...
  "book-hooke": { src: "/figures/book/hooke_cork.jpg", alt: "原书网页：Robert Hooke 在 Micrographia 里画的软木细胞" },
  "book-quantify-exp": { src: "/figures/book/quantifying_gene_exp.png", alt: "原书网页：从转录爆发到蛋白质的数量级" },
  "book-raw-basic-stats": { src: "/figures/book/raw-basic-stats.jpg", alt: "原书网页：FastQC Basic Statistics 好文库示例" },
  "book-raw-per-tile": { src: "/figures/book/raw-per-tile.jpg", alt: "原书网页：FastQC per-tile sequence quality，好与差对照" },
  "book-raw-n-content": { src: "/figures/book/raw-n-content.jpg", alt: "原书网页：FastQC per-base N content，好与差对照" },
  "book-raw-duplication": { src: "/figures/book/raw-duplication.jpg", alt: "原书网页：FastQC sequence duplication levels，好与差对照" },
  "book-raw-length": { src: "/figures/book/raw-length.jpg", alt: "原书网页：FastQC sequence length distribution，好与差对照" },
  "book-tumor-tracing": { src: "/figures/book/tumor-tracing.png", alt: "原书网页：肿瘤谱系示踪把 CRISPR 条码写进基因组" },
